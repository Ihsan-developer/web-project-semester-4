...
<head> 
    ...
    <!-- favicon -->
    <link rel="shortcut icon" href="img/beranda/logo.ico">
    <!-- Bootstrap -->
    ...
    <!-- Main Css -->
    <link href="css/beranda/style.min.css" rel="stylesheet" type="text/css" id="theme-opt" />
    <link href="css/beranda/color.css" rel="stylesheet" id="color-opt">
    <link href="css/beranda/index.css" rel="stylesheet" >
    <!--JQuery-->
...
<body>
    ...
    <script src="js/beranda/tiny-slider-init.js"></script>
    <!-- Counter -->
    <script src="js/beranda/counter.init.js"></script>
    <!-- Icons -->
    ...
    <!-- Main Js -->
    <script src="js/beranda/app.js"></script>
    <script src="js/beranda/index.js"></script>
    <!-- jQuery -->
